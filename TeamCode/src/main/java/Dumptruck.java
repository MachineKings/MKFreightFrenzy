...
public class Dumptruck {
    ...
    public void  extend bucketarm(){
        bucketarm.setTargetPosition();
    }

    public void spin carousel () {
        carousel.setPosition(0);
    }

    //bucketarm stop functions
    public void setbucketarmStopUp(){
        armStop.setPosition(1);
    }

    public void bucketarmStopDown (){
